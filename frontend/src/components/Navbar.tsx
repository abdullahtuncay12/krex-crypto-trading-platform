...
export const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-gray-50 dark:bg-crypto-dark-800/80 dark:backdrop-blur-md border-b border-gray-200 dark:border-crypto-dark-500/50 transition-colors duration-200">

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-white">Crypto Signals</span>
          </Link>
          ...
          <div className="flex items-center space-x-3">
            {isAuthenticated ? (
              <>
                ...
                <div className="flex items-center space-x-2 px-3 py-1.5 bg-crypto-dark-700 border border-buy/30 rounded">
                ...
                <div className="flex items-center space-x-2 px-3 py-1.5 bg-crypto-dark-700 rounded">
                  <div className="w-7 h-7 bg-gradient-to-br from-crypto-yellow-500 to-crypto-yellow-600 rounded-full flex items-center justify-center">
